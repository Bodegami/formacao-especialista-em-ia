...
documentos = sum(
    # Aqui usamos a função sum para concatenar as listas de documentos carregados de cada arquivo PDF em uma única lista de documentos. O segundo argumento [] é o valor inicial para a soma, garantindo que o resultado final seja uma lista.
    [
